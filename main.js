...
// const sortedYears = year2000.map( (year, next, array) => year.startYear).sort()
...
// let x = businesses.filter((company) => company.startYear > 2000)
// .sort((company1, company2) => (company2.startYear <
//     company1.startYear ? 1:-1))
//     console.log(x)
...
//     const multiplyNumbersBy5 = onlyNumbersAllowed.map((value) => {
...
//alternative solution LaToddra
// function byFive(array){
//     return array.filter(value=>value>0 && value%1 === 0)
//     .map((val) => val * 5)
// }


// console.log(byFive(numbers2))
...
console.log(countRepetition(arr1))
console.log(countRepetition(arr2))
